          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col col-lg-4">
                ...
                <button className="sbtn sbtn-gray mb-1 float-right gear" onClick={() => this.setShowConfig(!this.state.showConfig)}>
                ...
                <span className="text-danger float-right" style={this.state.warning ? null : {display: 'none'} } id="error-shuffle">Failed to start shuffle, please select a playlist</span>
              </div>
            </div>
          </div>
        </div>
